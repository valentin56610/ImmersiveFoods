...
public class Registration {
    ...
    public static final Item.Properties ITEM_PROPERTIES = new Item.Properties().stacksTo(64);
    ...
    //Frog
    public static final RegistryObject<Item> RAW_FROG_LEGS = ITEMS.register("raw_frog_leg", () -> new Item(ITEM_PROPERTIES.food(FoodValues.RAW_SQUID_FOOD)));
